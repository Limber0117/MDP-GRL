...
def parse_MDP_GRL_args():
    parser = argparse.ArgumentParser(description="Run")

    parser.add_argument('--seed', type=int, default=2019,
                        help='Random seed.')

    parser.add_argument('--data_name', nargs='?', default='mimic',
                        help='Choose a dataset from {yelp2018, last-fm, amazon-book , mimic}')
    parser.add_argument('--data_dir', nargs='?', default='datasets/',
                        help='Input data path.')

    parser.add_argument('--patient_pretrain', type=int, default=0,
    ...
    parser.add_argument('--test_batch_size', type=int, default=10000,
                        help='Test batch size (the patient number to test every batch).')

    parser.add_argument('--embed_dim', type=int, default=64,
                        help='Patient / entity Embedding size.')
    ...
    parser.add_argument('--aggregation_type', type=str, default='bi-interaction',
                        help='Specify the type of the aggregation layer from {bi-interaction}.')
    ...
    parser.add_argument('--adversarial_temperature', type=float, default=4,
                        help='alpha value for the algorithm.')
    parser.add_argument('--beta', type=float, default=3.0,
                        help='Beta value for the algorithm.')
    parser.add_argument('--gamma', type=float, default=3.0,
                        help='gamma value for the algorithm.')
    ...
    parser.add_argument('--Ks', nargs='?', default='[1, 3, 5]',
                        help='Calculate metric@K when evaluating.')

    args = parser.parse_args()

    save_dir = 'trained_model/MDP_GRL/{}/embed-dim{}_relation-dim{}_{}_{}_{}_lr{}_pretrain{}/'.format(
        args.data_name, args.embed_dim, args.relation_dim, args.laplacian_type, args.aggregation_type,
        '-'.join([str(i) for i in eval(args.conv_dim_list)]), args.lr, args.patient_pretrain)
